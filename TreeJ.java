/* implementation of b-tree in java */

public class BTreeNode
{
	public int[] data;
	public BTreeNode[] child_ptr;
	public boolean leaf;
	public int n;
}
...
public class GlobalMembers
{
	...
	public static BTreeNode np = null;
	public static BTreeNode x = null;
	...
	public static void traverse(BTreeNode p)
	{
		System.out.print("\n");
		int i;
		for (i = 0; i < p.n; i++)
	...
	public static int split_child(BTreeNode x, int i)
	{
		int j;
		int mid;
		BTreeNode np1;
